    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
        <div class="container">
          ...
          <div 
            ...
            <ul 
                class="text-dark navbar-nav ms-auto mb-2 mb-lg-0">
              <li 
                class="nav-item">
                <a 
                class="nav-link" 
              ...
              <li 
                class="nav-item">
                  <a 
                      class="nav-link" 
                      href="index.php#article">Article</a>
                </li>
                <li 
                    class="nav-item">
                  <a 
                    class="nav-link" 
                    href="index.php#gallery">Gallery</a>
                </li>
                <li
                class="nav-item">
                  <a 
                      class="nav-link" 
                      href="index.php#schedule">Schedule </a>
                </li>
                <li
                   class="nav-item">
                  <a 
...
if ($_REQUEST) {
  ...
  if ($_POST['user'] == "admin" and $_POST["pass"] == "123456"){
